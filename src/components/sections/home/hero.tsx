  ...
  return (
    <section className="relative overflow-hidden pb-24 pt-28">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-y-0 -left-24 h-full w-72 rounded-full blur-lg md:blur-3xl" aria-hidden="true" />
        <div className="absolute inset-y-0 -right-24 h-full w-72 rounded-full blur-lg md:blur-3xl" aria-hidden="true" />
      </div>
